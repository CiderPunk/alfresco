...
export class Wasp extends Killable implements IPooledItem<Wasp>, IKillable{
  ...
  static waspMeshNode: TransformNode;
...
//his.stingAnim.start(true)
  ...
  static LoadAssets(assMan:AssetsManager){
    ...
    task.onSuccess = (task)=>{ 
      ...
      Wasp.waspMeshNode = root.getChildTransformNodes(true,n=>n.id == "wasp")[0]
      Wasp.animations = new Map<string,AnimationGroup>()
      task.loadedAnimationGroups.forEach(a=>{ Wasp.animations.set(a.name, a)})
    }
  } 
